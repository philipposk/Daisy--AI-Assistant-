#!/usr/bin/env python3
"""
Daisy Assistant 1.1 - Main CLI entrypoint
    ...
    def _push_undo(self, action) -> None:
        ...
        try:
            ...
            if at == "create_note" and action.create_note:
                # We need the actual file path; ActionService writes note_path but
                # doesn't return it. Reconstruct from config + title.
                ...
                self.undo_stack.push(UndoEntry(
                    ...
                    metadata={"message": action.create_reminder.message},
                ))
