#!/usr/bin/env python3
"""
Daisy Assistant - Main CLI entrypoint
...
class DaisyPipeline:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        self.dispatcher = ActionDispatcher(self.config, self.audit_logger)
    ...
    def process_text(self, text: str) -> str:
        ...
        # Create transcription result from text
        from schemas import TranscriptionResult
    ...
    def voice_loop(self):
        ...
        self.voice_service.text_to_speech(greeting)
